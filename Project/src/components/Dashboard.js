            ...
            <div className="col-xl-3 col-sm-6 py-2">
              <div className="card bg-success text-white h-100">
                ...
                >
                  ...
                  <h6 className="text-uppercase">Movies</h6>
            ...
            <div className="col-xl-3 col-sm-6 py-2">
              <div className="card text-white bg-info h-100">
                <div className="card-body bg-info">
                  ...
                  <h6 className="text-uppercase">Ticets</h6>
            ...
            <div className="card-deck">
              ...
              <div className="card card-inverse card-danger text-center">
                <div className="card-body">
                  <blockquote className="card-blockquote">
                    <p>
                      The Bootstrap 3.x element that was called "Panel" before,
                      is now called a "Card".
                    </p>
                    <footer>
              ...
              <div className="card card-inverse card-info text-center">
                <div className="card-body">
                  <blockquote className="card-blockquote">
                    <p>
                      If you want to use cool icons in Bootstrap 4, you'll have
                      to find your own such as Font Awesome or Ionicons.
                    </p>
                    <footer>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  In addition to the five default responsive tiers, Bootstrap
                  4 includes a new XL (extra large) tier.
                </p>
              </div>
            </div>
            ...
            <div className="col-lg-6">
              <div className="card mb-3">
                <div className="card-body">
                  ...
                  <p>
                    Bootstrap 4 will be lighter and easier to customize thanks
                    to support for CSS variables and Sass.
                  </p>
                  <p className="card-text">
                    <small className="text-muted">Last updated 3 mins ago</small>
                  </p>
